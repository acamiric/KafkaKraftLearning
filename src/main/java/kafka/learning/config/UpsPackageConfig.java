...
@Configuration
@ComponentScan(basePackages = {"kafka.learning"})
public class UpsPackageConfig {
  ...
  public ConsumerFactory<String, Object> consumerFactory(@Value("${kafka.bootstrap-servers}") String bootstrapServers) {
    ...
    config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, UpsPackage.class.getCanonicalName());
